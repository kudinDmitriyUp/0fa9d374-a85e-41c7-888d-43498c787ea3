...
export const metadata: Metadata = {
  title: "ONA KOJU NE PUŠTAJU | Transformiši svoju dinamiku",
  description: "Kompletan vodič muške psihologije. Prestani da čekaš njegovu poruku. Postani devojka koju ON očekuje. 27€ samo danas.",
  keywords: ["muška psihologija", "odnosi", "transformacija", "samopouzdanje ženske", "dinamika"],
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "ONA KOJU NE PUŠTAJU",
    description: "Od čekanja do vladanja. Transformiši odnos u 5 vodiča. 27€ samo danas.",
    siteName: "ONA KOJU NE PUŠTAJU",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35zRAoB2uzBPsO0cWMSBwpbjhOB/uploaded-1764111201187-wwuu4sk1.jpg",
        alt: "ONA KOJU NE PUŠTAJU - Transformacija"
      }
    ]
  },
  twitter: {
    ...
    title: "ONA KOJU NE PUŠTAJU",
    description: "Prestani da čekaš. Počni da vladaš.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35zRAoB2uzBPsO0cWMSBwpbjhOB/uploaded-1764111201187-wwuu4sk1.jpg"]
  }
};
